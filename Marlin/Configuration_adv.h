...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_MIN_TRIGGER   200     // (°C) Minimum temperature to enable hotend protection
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_IDLE_TIME        5 // (seconds) Extra time to keep the fan running after disabling motors
...
// @section bltouch
   ...
   *
   * Set the default state here, change with 'M401 S' or UI, use M500 to save, M502 to reset.wilson
   */
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
    ...
    /**
     * Enable to init the Probe Z-Offset when starting the Wizard. wilson
 ...
 * Stop after G29_MAX_RETRIES attempts.wilson
 */
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     380  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  #define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.wilson
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      0  // (mm/s) feedrate to purge before unload
...
/**
 * Include capabilities in M115 output enabled for screen wilson
 */
